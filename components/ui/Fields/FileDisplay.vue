<template>
 ...
 >
 <AppIcon name="icon-[heroicons-outline--document]" :size="1.25" class="text-text-muted shrink-0" />
 <span class="text-text max-w-48 truncate text-sm">{{ displayName }}</span>
 <span v-if="loading" class="text-text-muted shrink-0 text-xs">(Uploading...)</span>
 <AppButton
