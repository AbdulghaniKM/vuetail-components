<template>
 ...
 class="flex w-full items-center justify-between gap-2 rounded-lg border border-border bg-surface px-4 py-2.5 text-start text-text transition-all focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20 disabled:cursor-not-allowed disabled:opacity-50"
 ...
 class="fixed z-[9999] rounded-lg border border-border bg-surface shadow-lg"
 :style="dropdownStyle"
 >
 <!-- Search -->
 <div v-if="searchable" class="border-b border-border p-2">
 <div class="flex items-center gap-2 rounded-md bg-muted px-3 py-1.5">
 <AppIcon name="icon-[heroicons-outline--magnifying-glass]" :size="0.875" class="shrink-0 text-text-muted" />
 <input
 ref="searchRef"
 v-model="searchQuery"
 type="text"
 ...
 class="px-3 py-2.5 text-center text-sm text-text-muted"
 >
 No results found
 </li>
 <li
