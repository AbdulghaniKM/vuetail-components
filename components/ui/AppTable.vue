  ...
  <div class="w-full">
              ...
              >
                ...
                >
                  <div
                    ...
                    :class="
                      column.key === 'actions' ? 'w-16' : 'w-full max-w-[10rem]'
                    "
                  />
                </td>
              </tr>
            ...
            <tr v-else-if="displayData.length === 0">
              <td :colspan="visibleColumns.length" class="py-16 text-center">
                <div class="flex flex-col items-center gap-3">
                  <div
                    class="bg-muted flex size-14 items-center justify-center rounded-xl"
                  >
                    <AppIcon
                  ...
                  <div>
                    <p class="text-text mb-0.5 text-sm font-medium">
                      {{ emptyMessage }}
                    </p>
                    <p v-if="searchQuery" class="text-text-muted text-xs">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      class="text-text-muted block max-w-[14rem] truncate text-start text-sm"
                    >
    ...
    >
      <div class="flex flex-wrap items-center gap-2">
        <span
          v-if="showPagination"
          class="text-text-muted text-sm tabular-nums"
        >
          {{ paginationStart }}&ndash;{{ paginationEnd }} {{ ofLabel }}
          {{ paginationTotal }}
        </span>
        ...
        <div v-if="showColumnToggle" ref="columnToggleRef" class="relative">
          ...
          >
            ...
            <span class="text-text-muted"
              >{{ visibleToggleableCount }}/{{ toggleableColumns.length }}</span
            >
          </button>
          <Transition
          ...
          >
            ...
            >
              ...
              <div class="py-1">
                ...
                >
                  ...
                  <span
                    ...
                    :class="
                      visibleColumnsSet.has(col.key) ? 'bg-accent' : 'bg-border'
                    "
                  >
                    <span
              ...
              >
                <AppIcon
                  name="icon-[heroicons-outline--arrow-path]"
                  :size="0.875"
                />
                Reset defaults
              </button>
      ...
      <div v-if="showPagination" class="flex items-center gap-1.5">
        ...
        <span v-else class="text-text px-2 text-sm font-medium tabular-nums">{{
          props.pageNumber
        }}</span>
        <AppButton
    ...
    >
      <p
        dir="auto"
        class="text-text whitespace-pre-wrap text-sm leading-relaxed"
      >
...
const visibleToggleableCount = computed(
  () =>
    toggleableColumns.value.filter((c) => visibleColumnsSet.value.has(c.key))
      .length,
);
